    ...
    <a href="index.php"><img src="image.svg" alt="logo" class="logo"></a>
      ...
      <nav>
        <ul class="nav-links">
          ...
          <li><a href="categories.client.php" class="nav-link">CATEGORIES</a></li>
          <li><a href="cart.php" class="nav-link">MY CART</a></li>
          <li><a href="mycommands.php" class="nav-link">MY COMMANDS</a></li>
          <li><a href="#" class="nav-link">LANGUAGE</a></li>
          <li><a href="about.client.php" class="nav-link">ABOUT</a></li>
        </ul>
        <div class="sign-btns"> 
          <div></div>
          <form action="signout.inc.php">
          <button class="btn signin-btn">Sign out</button>
          </form>
          <a href="profile.php"><button class="btn signup-btn">My profile</button></a>
          
            <img src="search.svg" alt="Cart" class="active"/>
          <img src="cart.svg" alt="Cart" class="cart"/>
        
            <form class="search-box" action="search.client.php" method="POST" >
              <input name="search" type="text" name="" class="search-input">
              <a href="search.client.php"><input  type="submit" value="search" class="search-btn"></a>
</form>
        </div>
      </nav>
    </header>
      ...
      <div class="row">
        ...
        <div class="total__amount">
          ...
          <div class="quantity__options">
                  ...
                  <form action="addtocart.php?pro_id=<?=$id?>" method="POST">
                  <input
                    type="number"
                    name="quantity"
                    id="quantity"
          ...
          <div class="btns">
            ...
            <button type="submit" name="addtocart" class="addtocart-btn">ADD TO CARD</button>
          </form>
