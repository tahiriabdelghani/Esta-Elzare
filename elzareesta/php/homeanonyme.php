...
.old{
    ...
    <body>
            ...
            <div  class="center">
                <a href="index.php
                "><img style="border-radius:6px; width:200px; margin-top: 15px; margin-left: 20px;" src="../images/estaelzarelogo.png" alt=""></a>
                <nav>
                    <form action="search.anonyme.php" method="POST" class=searcher >
                    ...
                    <ul class="navbut" style="margin-left:140px;">
                        <a href="index.php"><li>HOME</li></a>
                        <a href="categories.anonyme.php"><li>CATEGORIES</li></a>
                        <a href=""><li>LANGUAGE</li></a>
                        <a href="about.anonyme.php"><li>ABOUT</li></a>
