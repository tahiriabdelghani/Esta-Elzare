...
<nav >
		<a href="index.php"><img style="margin-top:8px; width:200px; height:auto;" src="../images/estaelzarelogo.png" class="logo"></a>
    <div class="sf">
		<!-- <form action="search.anonyme.php" method="POST"> -->
		<input type="text" name="search" placeholder="Search for products Here" name="h" 
		style="width:700px;margin-top:10px;height: 41px">
        <button style="width: 100px;margin-top: 10px;font-weight: bold;">Search</button>
	    <!-- </form> -->
    </div>
	    <form action="signup.php">
        <input type="submit" name="pop" value="Sign Up" class="movme" style="font-weight: bold">
		</form>
	<ul style="margin-right:370px;">
		<li><a href="index.php">Home</a></li>
        <li><a href="categories.anonyme.php">Categories</a></li>
